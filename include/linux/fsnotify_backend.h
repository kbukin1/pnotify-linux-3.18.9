...
/*
 * Task specific fields in an fsnotify_mark
 */
struct fsnotify_task_mark {
  struct task_struct *task;       /* task this mark is associated with */
  struct hlist_node t_list;       /* list of marks by task->pnotify_marks */
  struct list_head free_t_list;  /* tmp list used when freeing this mark */
