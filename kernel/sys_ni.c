...
cond_syscall(sys_pnotify_init);
cond_syscall(sys_pnotify_init1);
cond_syscall(sys_pnotify_add_watch);
cond_syscall(sys_pnotify_rm_watch);
cond_syscall(sys_pnotify_annotate);
